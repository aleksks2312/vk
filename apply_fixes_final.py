...
# JS Block updates
js_start = html.find('function tapAltar(event) {')
...
if js_start != -1 and js_end != -1:
    html = html[:html.rfind('function updateAltarUI() {', 0, js_start)] + new_js + html[js_end:]
    
# Remove alert emojis
html = html.replace("alert('Отправлено! +1 <svg class=\"energy-inline\" viewBox=\"0 0 24 24\"><polygon points=\"13 2 3 14 12 14 11 22 21 10 12 10 13 2\"></polygon></svg>');", "alert('Отправлено! +1 Энергия');")
html = html.replace("alert('Ссылка отправлена! +1 <svg class=\"energy-inline\" viewBox=\"0 0 24 24\"><polygon points=\"13 2 3 14 12 14 11 22 21 10 12 10 13 2\"></polygon></svg>');", "alert('Ссылка отправлена! +1 Энергия');")
html = html.replace("alert(`Ежедневный ритуал выполнен! Получено <svg class=\"dust-inline\" viewBox=\"0 0 24 24\"><path d=\"M12 2L15 9L22 12L15 15L12 22L9 15L2 12L9 9L12 2Z\"/></svg>${reward} пыли.`);", "alert(`Ежедневный ритуал выполнен! Получено ${reward} пыли.`);")
html = html.replace('alert("Видение получено! +100 <svg class=\\"dust-inline\\" viewBox=\\"0 0 24 24\\"><path d=\\"M12 2L15 9L22 12L15 15L12 22L9 15L2 12L9 9L12 2Z\\"/></svg> Пыли");', 'alert("Видение получено! +100 Пыли");')
html = html.replace("alert(\"У вас нет Энергии <svg class=\\\"energy-inline\\" viewBox=\\"0 0 24 24\\"><polygon points=\\"13 2 3 14 12 14 11 22 21 10 12 10 13 2\\"></polygon></svg>! Выполните Ритуал (пригласите друга или опубликуйте историю), чтобы получить попытку.\");", 'alert("У вас нет Энергии! Выполните Ритуал (пригласите друга или опубликуйте историю), чтобы получить попытку.");')
